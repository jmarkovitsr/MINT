...
let expName = 'MINT';  // from the Builder filename that created this script
...
function instructionsRoutineBegin() {
  ...
  text.setText('Please say in loud voice the name of the following pictures in the language requested\nPress any key to start');
...
function goodbyeRoutineBegin() {
  ...
  // update component parameters for each repeat
  text_2.setText('Thanks for your participation\n');
  // keep track of which components have finished
  goodbyeComponents = [];
  goodbyeComponents.push(text_2);
